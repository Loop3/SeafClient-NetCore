...
namespace SeafClient
{
    ...
    public class SeafSession
    {
        ...
        public async Task<IEnumerable<SeafDirEntry>> UploadSingle(SeafLibrary library, string targetDirectory, string relativePath, string targetFilename, Stream fileContent, Action<float> progressCallback = null)
        {
            library.ThrowOnNull(nameof(library));
        ...
        /// <param name="fileContent">The new content of the file</param>
        /// <param name="progressCallback">Optional progress callback (will report percentage of upload)</param>
        public async Task<IEnumerable<SeafDirEntry>> UploadSingle(string libraryId, string targetDirectory, string relativePath, string targetFilename, Stream fileContent, Action<float> progressCallback = null)
        {
            ...
            var uploadRequest = new UploadFilesRequest(AuthToken, uploadLink + "?ret-json=1", targetDirectory, relativePath, targetFilename, fileContent, progressCallback);
        ...
        /// <param name="fileContent">The new content of the file</param>
        /// <param name="progressCallback">Optional progress callback (will report percentage of upload)</param>
        public async Task<string> UpdateSingle(SeafDirEntry dirEntry, Stream fileContent, Action<float> progressCallback = null)
        {
            dirEntry.ThrowOnNull(nameof(dirEntry));
        ...
        /// <param name="fileContent">The new content of the file</param>
        /// <param name="progressCallback">Optional progress callback (will report percentage of upload)</param>
        public async Task<string> UpdateSingle(SeafLibrary library, string targetDirectory, string targetFilename, Stream fileContent, Action<float> progressCallback = null)
        {
            library.ThrowOnNull(nameof(library));
        ...
        /// <param name="fileContent">The new content of the file</param>
        /// <param name="progressCallback">Optional progress callback (will report percentage of upload)</param>
        protected async Task<string> UpdateSingle(string libraryId, string targetDirectory, string targetFilename, Stream fileContent, Action<float> progressCallback)
        {
            libraryId.ThrowOnNull(nameof(libraryId));
            targetDirectory.ThrowOnNull(nameof(targetDirectory));
            ...
            return await _webConnection.SendRequestAsync<string>(ServerUri, updateRequest);
        }
